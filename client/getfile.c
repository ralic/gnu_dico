/* $Id: getfile.c,v 1.1 2001/11/03 22:36:00 gray Exp $
 */
#ifdef HAVE_CONFIG_H
# include <config.h>
#endif
...
void 
YesDlgButtonCallbackProc(widget, closure, call_data)
    Widget widget;
...
void 
NoDlgButtonCallbackProc(widget, closure, call_data)
    Widget widget;
    XtPointer closure;  /* data the application registered */
    XtPointer call_data;/* callback specific data */
{

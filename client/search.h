...
int Handle_numstrokes __PROTO((Widget, XtPointer, XEvent *, Boolean *));
void Handle_romajikana __PROTO((Widget, XtPointer, XEvent *, Boolean *));
void BushuHandler __PROTO((Widget, XEvent *, String *, Cardinal *));
void dict_lookup __PROTO((Widget, XEvent *, String *, Cardinal *));
